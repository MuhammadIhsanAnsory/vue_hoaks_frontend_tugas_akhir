              ...
              <tbody>
                <tr v-for="(report, i) in reports.data" :key="i">
                  ...
                  <td class="text-center">
                    ...
                    <div v-else>
                        <v-chip disabled color="blue-grey darken-1" dark class="my-2"><v-icon left>task_alt</v-icon>Belum Diklarifikasi</v-chip>
                        <v-tooltip bottom>
                        <template v-slot:activator="{ on, attrs }">
                            <v-btn class="mb-2" dark small color="light-blue lighten-2" v-bind="attrs" v-on="on" link :to="`/admin/klarifikasi/${report.id}/${report.slug}`" >
                            <v-icon left> fact_check </v-icon> Klarifikasi Sekarang
                            </v-btn>
                        </template>
